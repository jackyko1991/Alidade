...
| Android (APK) | **[Latest build](https://github.com/jackyko1991/Alidade/releases/tag/app-latest)** | Isn't Play Store-signed, so you'll need to allow installs from unknown sources.|
...
matches their geometric pattern against a bundled star catalog, with no
prior pointing estimate required.
